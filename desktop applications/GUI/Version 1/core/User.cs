...
namespace Statistics
{
    class User
    {
        ...
        public User(int accountNumber, string first_name, string last_name, string rfid, string address, string zipCode, string email, string gender, DateTime dateOfBirth, double moneyBalance, bool inEvent, string password)
        {
        ...
        public User(string first_name, string last_name, int accountNumber, double moneyBalance)
        {
            this.first_name = first_name;
            this.last_name = last_name;
            this.accountNumber = accountNumber;
